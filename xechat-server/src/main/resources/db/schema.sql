...
CREATE TABLE IF NOT EXISTS pet_explore_chests (
    id                                TEXT PRIMARY KEY,
    account_id                        INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pet_explore_chests_account
    ON pet_explore_chests(account_id, status, chest_item_id, created_at);

CREATE TABLE IF NOT EXISTS pet_item_ledger (
    id            TEXT PRIMARY KEY,
    account_id    INTEGER NOT NULL,
    item_id       TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pet_item_ledger_account
